...
const BASE_COLUMNS: ColumnDef[] = [
  ...
  { key: 'name', label: '종목', align: 'left', headClass: TH_STICKY_NAME },
  {
    key: 'short',
    label: '단기 점수',
    tip: '지금 분위기·흐름을 0~100으로 나타낸 값이에요. 최근 점수 추세(모멘텀)·52주 가격 위치·시장 심리(애널리스트 기대)를 합쳐 매겨요. 자세한 계산은 방법론을 참고하세요.',
    align: 'left',
  },
  {
    key: 'long',
    label: '장기 점수',
    tip: '오래 묵힐 가치를 0~100으로 나타낸 값이에요. 수익성·성장성·회사 규모·목표주가 상승여력을 합쳐 매겨요. 자세한 계산은 방법론을 참고하세요.',
    align: 'left',
  },
  {
    key: 'dcf',
