...
export const NUMBER_GLOSSARY: NumberGlossaryEntry[] = [
  ...
  },
  {
    ...
    caution:
      '보수적으로 계산하기 때문에, 빠르게 성장하거나 현재 이익 대비 비싸게 거래되는 인기주(예: 대표 AI·반도체주)는 점수가 낮게 나오는 경향이 있습니다. 장기 점수는 높은데 DCF 점수가 낮다면 "좋은 기업이지만 성장 기대가 주가에 이미 반영된 상태"로 읽으면 됩니다. 미래 성장·할인율 가정이 바뀌면 결과가 크게 달라지고, 현금흐름이 마이너스이거나 자료가 부족한 종목·은행·보험 등은 제외됩니다. 미래 수익을 보장하지 않는 참고용 정보입니다.',
  },
]
